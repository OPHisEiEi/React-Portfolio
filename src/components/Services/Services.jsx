    ...
    <div className={styles.services_con}>
      ...
      <div className={styles.services_list}>
        ...
        <div className={styles.services_item}>
            ...
            <h4>Web Design</h4>
            <p>
                Lorem ipsum dolor sit amet <br /> consectetur adipisicing elit. Magni <br />recusandae enim consectetur <br />sapiente necessitatibus neque eos <br /> ipsa ullam minima nulla.
            </p>
        </div>
        <div className={styles.services_item}>
            <FaDesktop />
